  ...
  return <section id="admission" className="section-padding bg-accent">
      <div className="container-center">
        ...
        <div className="mb-12 flex flex-col items-center justify-center">
          ...
          <a href="#" className="inline-flex items-center gap-2 bg-primary hover:bg-accent-red text-white px-6 py-3 rounded-md font-medium transition-colors">
            <Download size={18} />
        ...
        <div>
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {faqs.map((faq, index) => <motion.div key={index} className="border border-primary rounded-lg overflow-hidden bg-white" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            once: true
                ...
                <button className="flex justify-between items-center w-full p-4 text-left font-medium focus:outline-none" onClick={() => toggleFaq(index)} aria-expanded={activeFaq === index}>

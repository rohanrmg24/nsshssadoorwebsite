...
const courses = [
  {
    ...
    features: [
      ...
      "Regular field trips and science exhibitions",
      "Special coaching for competitive exams like JEE, NEET"
    ]
  },
  {
    id: "commerce",
  ...
  },
  {
    ...
    features: [
      ...
      "Cultural and heritage study tours"
    ]
  }
];

const documents = [
  { name: "Academic Calendar 2025-26", type: "PDF", size: "1.2 MB" },
  { name: "Science Stream Syllabus", type: "PDF", size: "2.5 MB" },
  { name: "Commerce Stream Syllabus", type: "PDF", size: "2.3 MB" },
  { name: "Humanities Stream Syllabus", type: "PDF", size: "2.1 MB" },
  { name: "Exam Schedule", type: "PDF", size: "1.0 MB" },
  { name: "School Timetable", type: "PDF", size: "1.5 MB" },
];

const calendarEvents = [
  { date: "Jun 1, 2025", title: "Academic Year Begins", type: "academic" },
  { date: "Aug 15, 2025", title: "Independence Day Celebration", type: "event" },
  { date: "Sep 5, 2025", title: "Teachers' Day", type: "event" },
  { date: "Oct 2-15, 2025", title: "First Term Examinations", type: "exam" },
  { date: "Oct 21-30, 2025", title: "Autumn Break", type: "holiday" },
  { date: "Dec 22-Jan 5, 2026", title: "Winter Break", type: "holiday" },
  { date: "Jan 26, 2026", title: "Republic Day Celebration", type: "event" },
  { date: "Feb 15-28, 2026", title: "Pre-Board Examinations", type: "exam" },
  { date: "Mar 10-30, 2026", title: "Board Examinations", type: "exam" },
  { date: "Apr 15, 2026", title: "Academic Year Ends", type: "academic" },
];
        ...
        <div className="mb-16">
          <div className="flex flex-wrap justify-center mb-6 border-b">
            {courses.map((course) => (
              <button
                key={course.id}
                className={`px-6 py-3 font-medium text-sm sm:text-base relative ${
                  activeTab === course.id ? "text-primary" : "text-gray-600"
                }`}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-8 flex justify-center">
                      <a 
                        href="#" 
                        className="inline-flex items-center bg-primary hover:bg-accent-red text-white px-6 py-3 rounded-md font-medium transition-colors"
                      >
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4 justify-between">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 rounded-md border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-primary"
                  value={searchTerm}
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded-md text-sm ${activeFilter === "all" ? "bg-primary text-white" : "bg-gray-200"}`}
                >
                  All
                </button>
                <button
                  onClick={() => setActiveFilter("exam")}
                  className={`px-3 py-1 rounded-md text-sm ${activeFilter === "exam" ? "bg-primary text-white" : "bg-gray-200"}`}
                >
                  Exams
                </button>
                <button
                  onClick={() => setActiveFilter("holiday")}
                  className={`px-3 py-1 rounded-md text-sm ${activeFilter === "holiday" ? "bg-primary text-white" : "bg-gray-200"}`}
                >
                  Holidays
                </button>
                <button
                  onClick={() => setActiveFilter("event")}
                  className={`px-3 py-1 rounded-md text-sm ${activeFilter === "event" ? "bg-primary text-white" : "bg-gray-200"}`}
                >
                  Events
                </button>
              </div>

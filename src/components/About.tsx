...
const timelineItems = [{
  year: "1960",
  title: "Founding",
  description: "NSS HSS Adoor was established to provide quality education to the local community."
}, {
  year: "1975",
  title: "Higher Secondary",
  description: "The school was upgraded to a Higher Secondary institution."
}, {
  year: "1990",
  title: "New Building",
  description: "A new multi-story building was inaugurated to accommodate growing student strength."
}, {
  year: "2005",
  title: "Technology Lab",
  description: "State-of-the-art computer and science laboratories were established."
}, {
  year: "2020",
  title: "Diamond Jubilee",
  description: "Celebrated 60 years of academic excellence and community service."
}];
  ...
  return <section id="about" className="section-padding bg-accent">
      <div className="container-center">
        <div className="text-center mb-12">
          ...
          <p className="max-w-3xl mx-auto font-normal text-lg">NSS HSS Adoor has been shaping young minds for over 60 years.</p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="relative">
            ...
            <div className="space-y-8 md:space-y-12">
              {timelineItems.map((item, index) => <motion.div key={item.year} className={`relative flex flex-col md:flex-row ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              margin: "-100px"
                  ...
                  <div className="flex-1 md:w-1/2 pl-12 md:pl-0 mb-4 md:mb-0 relative">
                    ...
                    <div className={`p-6 rounded-lg shadow-md bg-white h-full ${index % 2 === 0 ? "md:mr-8" : "md:ml-8"}`}>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {accordionItems.map((item, index) => <div key={index} className="border border-primary rounded-lg overflow-hidden bg-white">
                <button className="flex justify-between items-center w-full p-4 text-left font-medium focus:outline-none" onClick={() => toggleAccordion(index)} aria-expanded={activeAccordion === index}>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {staffMembers.map((member, index) => <motion.div key={index} className="group relative bg-white rounded-lg overflow-hidden shadow-md" whileHover={{
            y: -5,
            transition: {
              duration: 0.2
            }
            ...
            margin: "-50px"
                ...
                <div className="aspect-square overflow-hidden">
                  <img src={member.photo} alt={member.name} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
                </div>

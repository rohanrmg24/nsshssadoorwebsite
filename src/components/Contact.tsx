      ...
      <div className="container-center">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto">
            Have questions or want to learn more about our programs? Reach out to us, and we'll be happy to assist you.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-md border border-gray-300 focus:border-primary focus:outline-none transition-colors"
                >
              ...
              <div>
                <button
                  type="submit"
                  className={`w-full bg-primary hover:bg-accent-red text-white font-medium rounded-md px-6 py-3 transition-colors flex items-center justify-center ${
          ...
          <div>
            ...
            <div className="h-[300px] rounded-lg overflow-hidden shadow-sm">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.87219339898!2d76.72940271520727!3d9.00062219117627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0613a7aa1d1d03%3A0xa62d11a95d4fcee9!2sAdoor%2C%20Kerala!5e0!3m2!1sen!2sin!4v1651234567890!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                loading="lazy" 
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="flex-1 px-4 py-3 rounded-md border border-gray-300 focus:border-primary focus:outline-none" 
                required 
              />
              <button 
                type="submit"
                className="bg-primary hover:bg-accent-red text-white font-medium px-6 py-3 rounded-md transition-colors whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
